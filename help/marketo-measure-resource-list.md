...
* [Configuração de canal de marketing, prática recomendada](/help/channel-tracking-and-setup/marketing-channels-and-subchannels.md)
...
* [O que são parâmetros de UTM?](/help/channel-tracking-and-setup/utm-parameters.md)
* [Práticas recomendadas UTM](/help/channel-tracking-and-setup/best-practices-for-setting-up-utm-parameters.md)
* [Sincronização das campanhas do SFDC com os pontos de contato do comprador](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
* [Carregando gasto com marketing](/help/marketing-channel-costs.md)
* [Reconectar contas publicitárias](/help/api-connections/reauthorizing-connected-accounts.md)
* [Adicionando [!DNL Marketo Measure] JavaScript](/help/marketo-measure-tracking/adding-marketo-measure-script.md)
   * [Excluir Forms](/help/marketo-measure-tracking/excluding-marketo-measure-from-specific-forms.md)

**Relatórios**

* [Criando Tipos de Relatório Personalizados com [!DNL Marketo Measure]](/help/marketo-measure-salesforce-reporting/creating-report-types.md) (se você precisar relatar campos personalizados de Cliente Potencial/Contato/Oportunidade)
* [Glossário de  [!DNL Marketo Measure]  campos](/help/glossary.md)

**Solução de problemas**

* [Concedendo [!DNL Marketo Measure] Acesso de Suporte ao SFDC](/help/salesforce-access.md)
