...
![Abra o arquivo Power BI do Modelo de Relatórios do Adobe Marketo Measure.](assets/marketo-bi-1.png)

Você pode encontrar suas informações específicas de servidor, warehouse e esquema na interface do [!DNL Marketo Measure] na página de informações do [!DNL Data Warehouse]. As instruções para localizar esta página estão detalhadas [aqui](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
Os parâmetros inseridos ao abrir o arquivo são usados para estruturar consultas nativas que importam tabelas do Data Warehouse. Você ainda precisará configurar uma conexão de dados com a instância do [!DNL Snowflake]. Para isso, é necessário os mesmos nomes de servidor e warehouse, juntamente com seu nome de usuário e senha. Detalhes de onde encontrar seu nome de usuário e redefinir sua senha, se necessário, estão documentados [aqui](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
![Para limitar os dados importados para o modelo, cada tabela é definida](assets/marketo-bi-2.png)
...
![Porque os filtros de data são aplicados à data modificada de um](assets/marketo-bi-3.png)
...
![Algumas transformações foram aplicadas aos dados no Power Query.](assets/marketo-bi-6.png)
...
![A maioria das tabelas no data warehouse do Marketo Measure contém dimensões desnormalizadas](assets/marketo-bi-7.png)
...
![Tabelas e colunas foram renomeadas para torná-las mais amigáveis](assets/marketo-bi-5.png)
...
![A tabela de Taxa de Conversão armazenada no Snowflake contém um intervalo de datas](assets/marketo-bi-9.png)

## Modelo de dados {#data-model}

Clique na imagem abaixo para obter a versão em tamanho normal.

[![Clique na imagem abaixo para obter sua versão em tamanho normal.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![As medidas de conversão de moeda neste modelo substituem um valor de 1,0](assets/marketo-bi-13.png)
...
![As definições foram adicionadas ao modelo de Power BI para tabelas, personalizado](assets/marketo-bi-15.png)

![As definições foram adicionadas ao modelo de Power BI para tabelas, personalizado](assets/marketo-bi-16.png)

![As definições foram adicionadas ao modelo de Power BI para tabelas, personalizado](assets/marketo-bi-14.png)

Para exibir definições de colunas provenientes diretamente do [!DNL Snowflake], consulte a [documentação do data warehouse](/help/data-warehouse-schema.md){target="_blank"}
