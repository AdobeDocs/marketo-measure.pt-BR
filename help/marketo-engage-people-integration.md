...
![Para que possamos detectar essas duplicatas, verifique se](assets/marketo-engage-programs-06.png)

![Para que possamos detectar essas duplicatas, verifique se](assets/marketo-engage-programs-07.png)
...
![Ao criar relatórios sobre clientes potenciais (pessoas) no Marketo Measure Discover, você](assets/bizible-discover-1.png)

![Ao criar relatórios sobre clientes potenciais (pessoas) no Marketo Measure Discover, você](assets/bizible-discover-2.png)
