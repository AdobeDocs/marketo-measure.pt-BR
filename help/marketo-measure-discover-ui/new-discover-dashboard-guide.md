  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>Resumo do ROI da Palavra-chave e Creative:</strong>Obsoleto (veja abaixo)</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>BT/BAT Ao Longo Do Tempo:</strong>Painel De Envolvimento</li>
          <li>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            <strong>Funnel de coorte:</strong>Painel de Jornada de coorte</li>
          <li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>Resumo do ROI da Palavra-chave e Creative</strong>
        </p>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>Obsoleto devido ao seu potencial para confundir os usuários. Nosso objetivo é clareza e valor imediato dos dados.</td>
    </tr>
  </tbody>
</table>
...
* **Tipo de data, Métrica, Dimension, Agrupar por**: essas configurações agora são predefinidas para cada painel para otimizar a entrega do insight. Especificações detalhadas podem ser acessadas por meio de dicas de ferramentas e da documentação que as acompanha.
* **Fonte da campanha**
* **ID e Nome da Conta**: em revisão.

## Novas adições e melhorias {#new-additions-and-improvements}

Novos recursos podem ser encontrados no artigo [Noções básicas sobre o painel](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}.
