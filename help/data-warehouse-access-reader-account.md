...
1. No menu do lado esquerdo, em Segurança, clique em **[!UICONTROL Data Warehouse]**.
   ...
   ![1. No menu do lado esquerdo, em Segurança, clique em Data Warehouse.](assets/data-account-8.png)

1. Esta página tem o link para o data warehouse da Snowflake e seu nome de usuário.

   ![1. Esta página tem o link para seu data warehouse Snowflake e](assets/data-account-9.png)
...
![Somente mostramos a senha temporária na interface do usuário. Um email](assets/data-account-3.png)

![Somente mostramos a senha temporária na interface do usuário. Um email](assets/data-account-1.png)
