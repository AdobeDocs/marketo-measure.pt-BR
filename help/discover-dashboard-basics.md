...
![Passe o mouse sobre o canto superior direito de um visual para ver uma lista somente leitura de](assets/discover-3b-1.png)
...
![Ative o detalhamento clicando na única seta para baixo, realçada por um cinza](assets/discover-basics-8.png)

Para detalhar um campo por vez, ative o ícone de detalhamento e selecione um elemento visual, como uma barra.

![Para detalhar um campo por vez, ative o detalhamento](assets/discover-basics-2.gif)

Use o ícone de drill-down da seta dupla para avançar para o próximo nível de hierarquia.

![Use o ícone de seta dupla para detalhar para avançar para a próxima hierarquia](assets/discover-basics-1.gif)

Use o ícone de bifurcação para adicionar outro nível de hierarquia na exibição atual.

![Use o ícone de bifurcação para adicionar outro nível de hierarquia em seu](assets/discover-basics-12.gif)
...
![Para explorar os dados por trás do visual, clique com o botão direito do mouse no elemento visual e](assets/discover-basics-13.gif)
...
![Selecionar um rótulo de valor ou eixo em uma visualização irá cruzar o filtro com outro](assets/discover-basics-3.gif)
...
![As dicas de ferramentas oferecem detalhes suplementares sobre os dados exibidos. Passe o mouse sobre um visual](assets/discover-basics-4.gif)
