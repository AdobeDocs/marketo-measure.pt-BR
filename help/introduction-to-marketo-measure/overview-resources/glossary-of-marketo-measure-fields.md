...
Para obter um mapa ao qual cada Campo do Marketo Measure está relacionado, [clique aqui](/help/configuration-and-setup/marketo-measure-and-salesforce/marketo-measure-object-and-field-taxonomy.md).
...
`2)` Se o touchpoint não veio da pesquisa paga, o campo será preenchido usando o valor utm_campaign do URL da landing page.
...
`2)` Se o touchpoint não veio da pesquisa paga e o URL da landing page contiver um valor para utm_campaign, esse valor será preenchido aqui.
...
`2)` Se o touchpoint não for de pesquisa paga, esse campo exibirá o valor utm_content no URL da landing page.
...
**ID do experimento** |Teste A/B do Marketo Measure
...
`1)` Se o touchpoint for proveniente de uma pesquisa paga, esse campo exibirá o texto da palavra-chave da plataforma de publicidade (Adwords/BingAds) OU o valor do parâmetro _bk no URL da página inicial.
...
`2)` Se o touchpoint não for proveniente de uma pesquisa paga, esse campo exibirá o valor utm_term do URL da landing page.
...
`2)` Se o touchpoint não for proveniente de uma pesquisa paga, esse campo exibirá o valor utm_medium do URL da landing page.
...
`3)` Se não for #1 ou #2, e o valor utm_source estiver presente no URL da landing page do touchpoint, esse valor será exibido aqui
