...
![Guia Configurações mostrando a página de configuração Atividades para regras de atribuição](assets/1.png)
...
![Campo Nome da Campanha com exemplo de parâmetro de substituição dinâmico para Vendas de Saída](assets/2.png)
...
![Interface de configuração de regras de atividade mostrando critérios de filtro com opções de instrução e/ou](assets/3.png)
...
![Seleção do campo de data do Buyer Touchpoint mostrando as opções de campo de data padrão e personalizado](assets/4.png)
...
![Seletor de tipo de objeto mostrando as opções de Tarefas e Eventos para regras de atividade](assets/5.png)
...
![Página de configuração Canal de marketing mostrando o mapeamento de campanha com opções de operador curinga](assets/6.png)
...
![Interface de carregamento de Gastos de marketing para inserir custos de canal por mês com rastreamento de ROI](assets/7.png)

>[!MORELIKETHIS]
>[Perguntas frequentes sobre atribuição de atividade](/help/advanced-features/activities-attribution/activities-attribution-faq.md)
