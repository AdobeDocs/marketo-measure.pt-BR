...
![Página de configurações de Campos de Ponto de Contato com a opção Habilitar Campos Calculados](assets/one.png)
...
O operador [!UICONTROL extrai] o valor de um campo de outro local, como: um campo do Campaign, campo de cliente potencial ou, em um caso de uso mais avançado, extrair parâmetros personalizados da página de aterrissagem. Em seguida, o coloca em um Campo de ponto de contato.
...
![Configuração de campo calculada para extração de campo do Campaign Source](assets/two.png)
...
![A configuração do campo Código de Desconto está extraindo o parâmetro promocional da URL](assets/three.png)
...
![Campo da Adobe Campaign Id extraindo parâmetro de cid de 6 dígitos](assets/four.png)
...
![Vários campos calculados extraindo os parâmetros de ID de país e campanha](assets/five.png)
...
![Campanhas de mapeamento de campo de iniciativa para categorias de promoção](assets/six.png)
...
![Tabela de mapeamento de nomes de região com códigos numéricos para nomes de região](assets/seven.png)

### Concatenadas {#concatenates}
...
![Configuração de concatenação combinando campos de segmento e grau](assets/eight.png)
...
![Interface de criação de segmento mostrando os campos de ponto de contato disponíveis](assets/nine.png)
...
![Configuração de segmento dinâmico com referência de campo de chave](assets/ten.png)

A regra faz referência ao mesmo Campo de ponto de contato e pesquisa valores que &quot;não são iguais a nulo&quot;.

![Regra de segmento com condição diferente de nula](assets/eleven.png)
...
![Ferramenta de validação Regex mostrando expressão válida em verde](assets/twelve.png)

![Ferramenta de validação Regex mostrando expressão inválida em vermelho](assets/thirteen.png)
