...
Para obter mais informações sobre a funcionalidade de atribuição do Modo de Exibição Através do [!DNL Marketo Measure], consulte as [Perguntas frequentes sobre o Modo de Exibição Através do Attribution do Marketo Measure](/help/advanced-features/view-through-attribution/marketo-measure-view-through-attribution-faq.md).
