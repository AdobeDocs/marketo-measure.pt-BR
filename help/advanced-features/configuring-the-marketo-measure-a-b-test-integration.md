---
description: Configurar a [!DNL Marketo Measure] orientação de Integração de Teste A/B para usuários do Marketo Measure
...
# Configurando a integração do teste A/B [!DNL Marketo Measure] {#configuring-a-b-testing}
