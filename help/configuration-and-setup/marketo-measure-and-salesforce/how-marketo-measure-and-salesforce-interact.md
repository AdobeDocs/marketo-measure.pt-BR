---
description: Como o  [!DNL Marketo Measure]  e o  [!DNL Salesforce]  interagem
...
![Configuração de tamanho de lote de exportação do Marketo Measure CRM no aplicativo Web](assets/how-bizible-and-salesforce-interact-2.png)
...
* Precisamos de permissões adicionais para o Campaign “Criar” e “Atualizar” em seus CRMs.

* Quando um ponto de contato é criado de uma atividade da Web, precisamos vinculá-lo a uma campanha. Como as atividades da Web não têm campanhas de CRM correspondentes, precisamos criar uma para estabelecer esse link. Isso se aplica aos pontos de contato de lead e de oportunidade. A permissão de atualização é necessária porque a chamada que usamos é “upsert”. Se o registro existe, nós o atualizamos, caso contrário, nós o criamos. Isso se aplica somente às campanhas que criarmos.
