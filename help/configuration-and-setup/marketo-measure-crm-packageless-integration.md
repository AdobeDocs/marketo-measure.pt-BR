...
[!DNL Salesforce] clientes clicam [aqui](/help/configuration-and-setup/install-set-up.md).

[!DNL Microsoft Dynamics] clientes clicam [aqui](/help/microsoft-dynamics-crm-installation-guide.md).
