---
description: Diretrizes do Connect Marketo Measure to Salesforce para usuários do Marketo Measure
...
1. Na seção CRM, em Conexões, clique em **[!UICONTROL Configurar Nova Conexão do CRM]**.
   ...
   ![1. Na seção CRM em Conexões, clique em Configurar Novo](assets/bizible-taxonomy-1.png)
...
![Você pode acessar esse limite no Marketo Measure por meio de: Configurações da Minha Conta](assets/connect-salesforce-2.png)
...
1. Clique no ícone Bloquear para editar.
   ...
   ![1. Clique no ícone Bloquear para editar.](assets/connect-salesforce-3.png)
