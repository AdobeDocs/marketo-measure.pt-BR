...
1. Selecione **[!UICONTROL Instalar] para Todos os usuários**.
   ...
   ![1. Selecione Instalar para Todos os Usuários.](assets/bizible-full-1.png)

1. Quando a instalação estiver concluída, você poderá visualizá-la.

   ![1. Após a conclusão da instalação, você poderá exibi-la.](assets/bizible-taxonomy-1.png)

Após concluir a instalação, você pode atualizar os [[!DNL Salesforce] layouts de página](/help/configuration-and-setup/page-layout-instructions.md){target="_blank"} com os campos [!DNL Marketo Measure], se desejar.

>[!NOTE]
>
>Leia sobre a criação de conjuntos de permissões do [!DNL Marketo Measure] e [como eles são usados](/help/configuration-and-setup/marketo-measure-permission-sets.md){target="_blank"}.
...
>
>* [Configuração do Adobe Admin Console](/help/configuration-and-setup/adobe-admin-console-setup.md){target="_blank"}
