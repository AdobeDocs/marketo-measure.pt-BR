---
description: Visão geral de como o Marketo Measure troca dados com o Salesforce, incluindo permissões de exportação e configurações de lote
...
![Se você não instalou o pacote Marketo Measure Salesforce,](assets/bizible-full-1.png)
...
![Por padrão, o Marketo Measure exporta 200 registros por crédito de API cada](assets/bizible-taxonomy-1.png)
