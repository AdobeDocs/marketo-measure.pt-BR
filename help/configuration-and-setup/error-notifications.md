---
description: Orientação de notificações de erro para usuários do Marketo Measure
...
![Para ver a mensagem de notificação completa no Marketo Measure, clique em Exibir](assets/adobe-setup-1.png)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Consulte a seguinte documentação do seu CRM para obter assistência no ajuste das alocações de crédito da API:</p>
          ...
          <p>
          &lt;img alt="notificações de erro 3" src="assets/error-notifications-3.png"
          </p>
      </td>
    </tr>
    <tr>
...
A documentação do Salesforce sobre acionadores de fluxo <a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">pode ser encontrada aqui</a>.
    ...
    <tr>
      ...
      <td>Revise o código do acionador que causa falha na inserção/atualização. Consulte a documentação do Salesforce a seguir para obter mais detalhes sobre acionadores:
        ...
        <p>
        Forneça todas as permissões necessárias ao <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">usuário do Marketo Measure</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Consulte o seguinte <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">artigo do Experience League</a> para obter orientação sobre as permissões exigidas pelo Marketo Measure.</td>
    </tr>
    <tr>
      ...
      <td>Consulte os seguintes artigos de ajuda para garantir a configuração correta:
        <ul>
          <li>
            <a href="/help/adobe-analytics.md">Integrações do Marketo Measure com o Adobe Analytics</a>
          </li>
          <li>
    ...
    <tr>
      ...
      <td>Exigimos permissões de leitura e gravação em todos os campos com o prefixo "bizible2__". Uma lista completa desses campos pode ser encontrada <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">neste artigo</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Há vários motivos para esse erro específicos à organização da Salesforce. Abaixo estão algumas etapas comuns de solução de problemas que podem resolver o problema:
        <ul>
          <li>Revise todas as permissões necessárias para cada <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">objeto e campo</a>.</li>
    ...
    <tr>
      ...
      <td>Atualize seu pacote para a versão mais recente:
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">Práticas recomendadas</a>
          </li>
