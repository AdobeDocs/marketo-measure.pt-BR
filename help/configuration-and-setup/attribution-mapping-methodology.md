---
description: Orientação da metodologia de mapeamento de atribuição para usuários do Marketo Measure
...
![Pronto para uso, a Marketo Measure fornece o mapeamento da ID da conta. Este](assets/adobe-setup-1.png)
...
![Embora a maioria dos clientes use o mapeamento de ID de conta, o Marketo Measure pode procurar](assets/adobe-setup-2.png)
...
![Além de simplesmente ver as funções de contato na oportunidade, o Marketo](assets/adobe-setup-3.png)
