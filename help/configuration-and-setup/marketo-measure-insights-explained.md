...
![Primeiro, você verá, na parte central dos seus insights, o número](assets/marketo-app-1.png)
...
![Os ícones que parecem papel indicam que ocorreu uma exibição de página](assets/marketo-app-2.png)
...
![O ícone que se parece com um copo indica que um teste A/B](assets/marketo-app-3.png)
...
![Se você clicar em qualquer sessão específica (é possível fazer isso clicando em](assets/marketo-app-4.png)
