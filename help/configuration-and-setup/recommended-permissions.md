...
Para enviar dados de ponto de contato para sua instância do [!DNL Salesforce], o usuário conectado deve ter acesso a [!DNL Marketo Measure] objetos personalizados (ou seja, Buyer Touchpoint e Buyer Attribution Touchpoint), bem como a objetos [!DNL Salesforce] padrão, como Clientes potenciais e Contatos. Consulte [[!DNL Marketo Measure] no Salesforce](/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md).
