...
Saiba mais sobre o [Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}.
...
![Em uma origem, selecione Adicionar Modelos de Uso de Dados](assets/marketo-guide-2.png)

* Selecione uma conta e todos os modelos B2B para criar dez esquemas B2B padrão.

![Selecione uma conta e todos os modelos B2B para criar dez B2B padrão](assets/marketo-guide-3.png)
...
1. Mapeie os campos a partir dos dados de origem para o esquema.
   ...
   >[!NOTE]
   >
   >[Requisito de integridade de dados do Marketo Measure Ultimate](/help/data-integrity-requirement.md){target="_blank"}
...
![Opção 1: para executar consultas diretamente da interface do usuário, acesse as Consultas](assets/marketo-guide-4.png)
...
![Os usuários podem mapear estágios de diferentes fontes.](assets/marketo-guide-5.png)
