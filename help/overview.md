...
![Níveis Marketo Measure 1-3](assets/marketo-overview-1.png)
...
![Espera-se que os profissionais de marketing tragam seus dados B2B (por exemplo, Conta, Oportunidade,](assets/marketo-overview-2.png)
...
![Dados de uma determinada entidade (por exemplo, Conta) a partir de determinados dados](assets/marketo-overview-6.png)
...
![As regras de ponto de contato de Membro da Campanha e as regras de ponto de contato da Atividade são específicas do conjunto de dados.](assets/marketo-overview-5.png)

![As regras de ponto de contato de Membro da Campanha e as regras de ponto de contato da Atividade são específicas do conjunto de dados.](assets/marketo-overview-8.png)
