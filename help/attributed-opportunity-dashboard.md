...
![Qual foi o detalhamento do valor de oportunidade atribuído por canal no mês passado?](assets/attributed-dashboard-3.png)
...
![Clique no ícone + ao lado de cada Canal para revelar o detalhamento por](assets/attributed-dashboard-1.png)
...
![Clique em uma ramificação para se aprofundar na camada de hierarquia subsequente.](assets/attributed-dashboard-2.png)
