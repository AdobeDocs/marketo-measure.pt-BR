...
A tabela de URL no [data warehouse](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} agora incluirá um campo de título da página, além das tabelas de dados da web.
...
* [Manual do novo painel do Discover](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
* [Noções básicas do painel do Discover](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
* [Painel de visão geral da receita](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
* [Painel de receita atribuída](/help/marketo-measure-discover-ui/attributed-revenue-dashboard.md){target="_blank"}
* [Painel de ROI](/help/marketo-measure-discover-ui/roi-dashboard.md){target="_blank"}
* [Painel de passaporte](/help/marketo-measure-discover-ui/passport-dashboard.md){target="_blank"}
...
![Configuração de tipo de relatório do Salesforce para Clientes Potenciais/Contatos com Pontos de Contato](assets/release-notes-2023-1.png)
...
![Colunas do relatório destacando campos FT/LC herdados de cliente potencial e contato a serem removidos](assets/release-notes-2023-2.png)

* Adicionar campos de touchpoint:

![Colunas de relatório mostrando campos de Touchpoint para adicionar no lugar de campos FT/LC](assets/release-notes-2023-3.png)
...
![Exemplo de configuração de filtro de Posição de Ponto de Contato](assets/release-notes-2023-4.png)

![Filtro de campo de data atualizado para campos baseados em Touchpoint](assets/release-notes-2023-5.png)
...
* O método desatualizado do OAuth com um RefreshToken será descontinuado. Consulte [este guia](/help/marketo-measure-and-dynamics/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} para atualizar as credenciais e seguir as práticas recomendadas da Microsoft para o uso do ClientSecret.
