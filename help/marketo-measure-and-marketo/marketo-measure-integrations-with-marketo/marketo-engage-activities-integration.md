...
1. Quando todas as atividades necessárias forem selecionadas, você poderá vê-las preenchidas em [!UICONTROL Lista de atividades selecionadas] e sob [!UICONTROL Definir regras].
...
1. No exemplo &quot;Alterar pontuação&quot;, é necessário inserir um Nome de campanha, pois essas informações são extraídas do programa Marketo. Agora crie a expressão de regra. Após este exemplo, selecione o campo &quot;[!UICONTROL Novo Valor]&quot; com um operador de &quot;[!UICONTROL é maior que]&quot; com um valor de 90.
...
1. Por fim, escolha o que usar como a Data do ponto de contato. Todos os campos de data ou hora disponíveis aparecem aqui no Marketo. A menos que tenha campos de data personalizados, você verá &quot;[!UICONTROL Data da atividade].&quot;
...
Alguns tipos de atividades nos fornecem a ID do programa e o Nome do programa, portanto, é fácil mapeá-los na ID da campanha e no Nome da campanha no ponto de contato do comprador. Para outros, não há associação de programa, portanto, parte da definição de regras requer que você crie um [!DNL Marketo Measure] Nome da campanha. Abaixo estão as listas de cada categoria:
...
Para qualquer uma das regras de um Tipo de atividade com uma ID de programa, o Canal de programa do Marketo é determinado a partir do programa. Usamos o Canal do programa para mapear para seus canais offline personalizados, portanto, é necessário verificar se seus canais estão configurados corretamente [conforme instruído aqui](/help/marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/marketo-engage-programs-integration.md#channel-mapping).
...
Mark clica em um anúncio do Facebook e acessa wayneenterprises.com, onde recebe um cookie com o [!DNL Marketo Measure] ID 123 e [!DNL Marketo Munchkin Id] 456. Não ocorre preenchimento de formulário.
...
O campo Tipo de ponto de contato foi criado no [!DNL Marketo Measure] pacote com 16 caracteres. Infelizmente, alterar o limite de caracteres do campo exigiria a substituição do campo existente e a criação de um. O valor do Tipo de ponto de contato é o Tipo de atividade, que também é definido no campo Médio.
