...
<p>
  ...
  <tr>
    ...
    <td>O cliente deve criar um Usuário da API do Marketo Engage dedicado e fornecer as credenciais ao Marketo Measure. Nenhuma configuração adicional de permissões é necessária. <a href="/help/marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/set-up-marketo-connection.md#configuring-the-integration">Saiba mais</a>.</td>
  </tr>
  <tr>
