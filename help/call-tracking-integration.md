---
description: Orientação de integração de rastreamento de chamadas para usuários do Marketo Measure
...
![&quot;Rastreamento de Chamadas&quot; no sentido geral é um produto de empresas como](assets/other-resources-6.png)
...
![Com a integração, você pode ver que a sessão da Web foi realmente](assets/other-resources-4.png)

## Como funciona {#how-it-works}

CallTrackingMetrics precisa fazer algum trabalho de desenvolvimento na ponta deles para que isso funcione. Com a JavaScript que eles colocam em seu site, CallTrackingMetrics pode pegar o `_biz_uid` do cookie [!DNL Marketo Measure]. Essa &quot;BizibleId&quot; é armazenada pelo CallTrackingMetrics.
...
![Abaixo está um exemplo de um registro de Tarefa com a BizibleId](assets/other-resources-5.png)
...
![Os valores do Tipo de Ponto de Contato que a Marketo Measure normalmente envia são Visita na Web,](assets/other-resources-1.png)
