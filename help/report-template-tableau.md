...
![Você precisa atualizar os dados de conexão existentes para sua Snowflake específica](assets/marketo-tableau-7.png)

## Conexão de dados {#data-connection}

Você precisará configurar uma conexão de dados com sua instância do Snowflake. Para isso, será necessário o nome do servidor, além do seu nome de usuário e senha. Detalhes sobre onde encontrar essas informações e redefinir sua senha, caso necessário, estão documentados [aqui](/help/data-warehouse-access-reader-account.md){target="_blank"}.

![Você precisa configurar uma conexão de dados com sua instância do Snowflake.](assets/marketo-tableau-5.png)
...
![Você também precisará inserir um comando SQL inicial. Isto suporta](assets/marketo-tableau-6.png)
...
![Há alguns lugares onde duas tabelas do Snowflake têm](assets/marketo-tableau-3.png)
...
![A coluna CATEGORY lista o número da categoria e a coluna SEGMENTNAME](assets/marketo-tableau-13.png)
...
![Os nomes podem ser atualizados de duas formas. A primeira opção é to](assets/marketo-tableau-14.png)
...
[![Clique na imagem abaixo para obter sua versão em tamanho normal.](assets/marketo-tableau-8.png)](assets/tableau-model-1.png){target="_blank"}
...
![Os dados de Cost e Touchpoint compartilham as dimensões Canal e Campanha. No entanto, Tableau](assets/marketo-tableau-10.png)
...
![Converter o valor da moeda corporativa para o valor de moeda selecionado na moeda corporativa](assets/marketo-tableau-11.png)
...
![As medidas de conversão de moeda neste modelo substituem um valor de 1,0](assets/marketo-tableau-12.png)
...
![As definições foram adicionadas ao modelo Tableau para parâmetros, custom](assets/marketo-tableau-15.png)
