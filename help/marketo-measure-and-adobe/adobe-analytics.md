...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td>Estágio mais profundo do Funnel</td>
   <td>O estágio mais profundo do funnel de qualquer oportunidade aberta associada ao usuário em questão.</td>
  </tr>
  <tr>
...
1. Content Analytics: use a métrica de receita para analisar qual conteúdo do site é mais envolvente para os clientes que compram seu produto ou serviço ou aqueles que atingem um estágio de interesse específico do funnel.
1. Suporte Live Deal: capacite sua equipe de vendas com um insight acionável analisando o comportamento do site para usuários associados a uma oportunidade aberta específica em seu CRM.
