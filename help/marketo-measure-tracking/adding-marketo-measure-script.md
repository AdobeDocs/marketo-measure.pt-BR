...
>[!TIP]
>Saiba como verificar se seu script é [compatível com o GDPR](/help/security/ensuring-consent-for-gdpr-in-marketo-measure-js.md){target="_blank"}.
...
Você encontra informações mais detalhadas [aqui](/help/marketo-measure-tracking/adding-marketo-measure-script-via-google-tag-manager.md){target="_blank"}.
...
Você tem formulários que NÃO devem ser rastreados por [!DNL Marketo Measure], pois não fazem necessariamente sentido para a atribuição (por exemplo, cancelar inscrição de formulários, logons de clientes e assim por diante)? Em caso afirmativo, adicione o código de exclusão [neste artigo](/help/marketo-measure-tracking/excluding-marketo-measure-from-specific-forms.md){target="_blank"} a cada formulário
...
![Exemplo de prompt de aviso do WAF para o script do Marketo Measure](assets/adding-marketo-measure-script-1.png)
...
* Solução: é necessário forçar um dos formulários a relatar o usuário para [!DNL Marketo Measure] com base nos dados em cache e discutir as práticas de abandono. Em geral, [relatar o código do usuário](/help/marketo-measure-tracking/ajax-form-handling.md){target="_blank"} pode resolver isso.
...
* Solução: esses [modelos de usuário de relatório](/help/marketo-measure-tracking/ajax-form-handling.md){target="_blank"} podem ser usados pela sua equipe de desenvolvimento da web para adicionar o código necessário.
