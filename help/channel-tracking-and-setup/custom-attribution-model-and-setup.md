...
1. Determine quais estágios você deseja incluir no modelo personalizado.
   ...
   ![Você tem permissão para até seis estágios personalizados (sem incluir os padrões:](assets/custom-models-1.png)
...
Se um campo personalizado for usado em seu modelo personalizado, o rastreamento do Histórico de campos DEVERÁ ser habilitado no CRM. Para obter instruções para habilitar o rastreamento do histórico do campo, consulte [Configuração do Modelo Personalizado: Habilitar o Rastreamento do Histórico do Campo](/help/channel-tracking-and-setup/custom-model-setup-enable-field-history-tracking.md).
...
![Depois que as porcentagens de atribuição tiverem sido salvas e processadas, os pontos de contato serão](assets/custom-models-3.png)
...
Agora você pode ver estágios personalizados em sua Funnel de marketing, mesmo que não tenha o Modelo personalizado ativado. Isso seria feito com o uso da funcionalidade do Funnel Stage. Os Estágios do funnel agora permitem adicionar estágios à funnel, mas não visualizam a atribuição deles.

Os Estágios do funnel ainda serão rastreados como Pontos de contato e ainda serão exibidos como Posições de ponto de contato no CRM. Sem o Modelo personalizado, esses Pontos de contato ainda poderão receber atribuição de toque intermediário se houver um preenchimento de formulário (10% para Toques intermediários), mas crédito de atribuição zero se for apenas uma visita à Web.
...
![Como você pode ver abaixo, incluímos o estágio de Diligência como separado](assets/custom-models-7.png)
