...
![Escolha em uma lista de Operadores que serão relacionados ao próximo](assets/touchpoint-settings-10.png)
...
![Ou adicione novas instruções fora do grupo para utilizar a lógica &quot;OR&quot;](assets/touchpoint-settings-11.png)
...
![3) Se suas regras se tornam complexas e você precisa recriar grupos](assets/touchpoint-settings-6.png)

Se você cometer um erro, não se preocupe. Também é possível excluir linhas individuais da instrução ou grupos completos.

![Se você cometer um erro, não se preocupe. Você pode excluir linhas individuais](assets/touchpoint-settings-7.png)
...
![4) Configure as regras para os Pontos de Contato de Atribuição do Comprador, se desejar](assets/touchpoint-settings-8.png)
