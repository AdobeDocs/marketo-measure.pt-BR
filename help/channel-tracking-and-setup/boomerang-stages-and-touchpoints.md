...
>[!NOTE]
>
>[Instruções sobre como configurar Estágios de Bumerangue](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md).
...
![Sem os estágios de Bumerangue (o &quot;antes&quot;), você só verá o MQL](assets/boomerang-stages-18.png) mais recente
...
![Usando o exemplo abaixo, esta conta do Marketo Measure incluiu MQL](assets/boomerang-stages-19.png)
...
**P: Eu tenho o Data Warehouse. Obtenho todos os dados ou o limite de Estágios de Bumerangue também se aplica a mim?**

O limite se aplica ao Data Warehouse e CRMs devido aos limites de processamento que [!DNL Marketo Measure] tem em vigor. O Data Warehouse também verá o limite de dez pontos de contato por estágio.
