...
![A planilha tem três colunas:](assets/offline-channels-1.png)
...
![Os tipos de campanha do SFDC aparecerão na guia Canal offline, listada](assets/offline-channels-10.jpg)
...
![É aqui que você pode criar o mapeamento de Canal/Subcanal no](assets/offline-channels-11.png)
...
![Abaixo está um exemplo de lógica que o Marketo Measure não](assets/offline-channels-12.png)
...
![No cenário acima, você criará uma Campanha exclusiva](assets/offline-channels-13.png)
...
Saiba mais sobre [sincronização offline [!DNL Salesforce] Campanhas com [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md).
...
![Depois de editar e atualizar a planilha com suas regras personalizadas, o](assets/offline-channels-20.png)
