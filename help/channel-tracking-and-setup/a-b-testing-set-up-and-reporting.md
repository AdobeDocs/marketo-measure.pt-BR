---
description: Configuração do teste A/B e orientação de relatórios para usuários do Marketo Measure
...
1. Edite o layout da página Lead e adicione a lista relacionada de **[!DNL Marketo Measure]testes A/B** na página.
   ...
   ![1. Editar o layout da página de cliente potencial e adicionar o Marketo Measure](assets/advanced-features-2.png)
...
1. Em [!UICONTROL Botões], desmarque **[!UICONTROL Novo]**.
   ...
   ![1. Em Botões, desmarque Novo.](assets/advanced-features-7.png)
...
![Marketo Measure A/BTests com oportunidade](assets/advanced-features-8.png)
...
![Teste A/B do Marketo Measure com lead](assets/advanced-features-9.png)

Teste A/B do **[!DNL Marketo Measure]com oportunidades**

![Teste A/B do Marketo Measure com oportunidade](assets/advanced-features-10.png)
