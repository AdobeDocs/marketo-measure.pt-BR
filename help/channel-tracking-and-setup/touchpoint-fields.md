...
![No menu Configurações do Marketo Measure, navegue até os Campos do Ponto de Contato](assets/touchpoint-fields-1.png)
...
![{6} é o número de caracteres que estamos extraindo](assets/touchpoint-fields-12.png)
...
![{6} é o número de caracteres que estamos extraindo](assets/touchpoint-fields-13.png)
...
![Você criou campanhas para uma &quot;Promoção de fim de verão&quot;](assets/touchpoint-fields-2.png)
...
![Para extrair o 10, você define o valor como &quot;BZ=\d{2}-\d{2}-\d{2}-\d{2}-(\d{2})&quot;](assets/touchpoint-fields-3.png)
...
![Há campos separados no objeto Oportunidade para Segmento e Gradec](assets/touchpoint-fields-4.png)
...
![A capacidade de criar segmentos usando campos de Touchpoint está disponível com este](assets/touchpoint-fields-5.png)
...
![A configuração seria parecida com a captura de tela abaixo. O Nome Do Segmento](assets/touchpoint-fields-6.png)

A regra faz referência ao mesmo Campo de ponto de contato e pesquisa valores que &quot;não são iguais a nulo&quot;.

![A regra faz referência ao mesmo Campo de Ponto de Contato e procura valores que](assets/touchpoint-fields-7.png)
...
![Há uma ferramenta online (https://regex101.com/(https://regex101.com/){target="blank"}) que você pode executar e testar](assets/touchpoint-fields-8.png)

![Há uma ferramenta online (https://regex101.com/(https://regex101.com/){target="blank"}) que você pode executar e testar](assets/touchpoint-fields-9.png)
