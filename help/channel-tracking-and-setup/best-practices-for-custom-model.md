...
* Atualizações na funnel de suas organizações
...
>[!MORELIKETHIS]
>
>* [Configuração e modelo de atribuição personalizados](/help/channel-tracking-and-setup/custom-attribution-model-and-setup.md)
>* [Habilitar O Rastreamento Do Histórico De Campos Para O Modelo Personalizado](/help/channel-tracking-and-setup/custom-model-setup-enable-field-history-tracking.md)
>* [Modelo de aprendizado de máquina](/help/channel-tracking-and-setup/machine-learning-model-faq.md)
