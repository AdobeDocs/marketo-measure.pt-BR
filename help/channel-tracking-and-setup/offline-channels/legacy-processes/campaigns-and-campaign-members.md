...
![Layout da página do Salesforce Campaign mostrando o campo Habilitar Pontos de Contato do Comprador](assets/1.png)

As opções disponíveis na lista de seleção são:

![Habilitar lista suspensa de pontos de contato do comprador com opções de inclusão de membros da campanha](assets/2.png)
...
![Registro de campanha mostrando os campos Data de Início do Ponto de Contato e Data de Término do Ponto de Contato](assets/3.png)
...
![Registro de membro da campanha mostrando campos de status do ponto de contato para lead, contato, oportunidade e data do status](assets/4.png)
...
![Registro de membro da campanha com campo de data do Buyer Touchpoint para substituição de data](assets/5.png)
...
![Layout da página de campanha com o botão de data de ponto de contato de atualização em massa](assets/6.png)
...
![Interface de Atualização em Massa mostrando pesquisa sem suporte para Datas Buyer Touchpoint nulas](assets/7.png)
...
![Interface de Atualização em Massa de Data do Ponto de Contato com o seletor de calendário e o botão Atualizar Registros Selecionados](assets/8.png)
