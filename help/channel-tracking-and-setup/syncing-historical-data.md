...
![Para sincronizar dados online históricos, os dados devem ser organizados no Salesforce](assets/dynamics-lists-1.png)
...
![Se os dados estiverem alojados em outro lugar (como ainda vivendo em Marketing](assets/dynamics-lists-10.png))
...
Mais informações sobre como sincronizar Listas de Marketing podem ser encontradas aqui: [[!DNL Dynamics] Campanhas e Listas de Marketing](/help/channel-tracking-and-setup/dynamics-campaigns-and-marketing-lists.md)
