---
description: Diretrizes de configurações para usuários do Marketo Measure
title: Configurações
...
**Moedas Avançadas**: um bit adicional que precisa ser habilitado se o cliente usar o recurso &quot;Gerenciamento Avançado de Moeda&quot; da Salesforce, no qual o usuário pode definir um intervalo com base no tempo para taxas de conversão.
...
![Nas suas Configurações de Usuário no Aplicativo Marketo Measure, nós](assets/multi-currency-1.png)
