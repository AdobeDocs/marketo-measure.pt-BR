...
![O Pacote do Marketo Measure Salesforce incluirá um campo rotulado](assets/dynamics-lists-1.png)

As opções disponíveis na lista de seleção são:

![As opções disponíveis na lista de opções são:](assets/dynamics-lists-10.png)
...
![Se antes de usar o Marketo Measure você usou uma plataforma de Automação de Marketing](assets/dynamics-lists-2.png)
...
![Isso pode ser necessário se uma lista foi carregada dias/semanas/meses após um](assets/dynamics-lists-4.png)
...
![A Data do Ponto de Contato de Atualização em Massa está incluída no Marketo](assets/dynamics-lists-5.png) instalado
...
![Há uma pesquisa que não funciona, exibida em](assets/legacy-processes-10.png)
...
![Depois que a data e a hora forem definidas, clique no link Atualizar Selecionados](assets/dynamics-lists-6.png)

## Custos de campanha {#campaign-costs}

Saiba tudo sobre os custos de campanha [neste artigo](/help/crm-campaign-costs.md){target="_blank"}.
