...
![Em qual período o site viu o número mais alto de Exclusivo](assets/web-dashboard-1.png)
...
![Criação de clientes em potencial a partir de formulários](assets/web-dashboard-2.png)
