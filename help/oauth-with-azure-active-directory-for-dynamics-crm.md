...
1. Depois de concluir o registro, o Azure AD atribui ao aplicativo um identificador de cliente exclusivo (a ID do aplicativo). Você precisa desse valor na próxima seção, portanto, copie-o da página do aplicativo.

1. Para localizar seu aplicativo no portal Azure, clique em **[!UICONTROL Registros de Aplicativo]** e em **[!UICONTROL Todos os Aplicativos]**. Abra o aplicativo recém-criado
...
b) Segredo do cliente é o segredo do aplicativo criado no Azure Portal para o seu aplicativo em Certificados e segredos.

![b. Segredo do Cliente é o segredo do aplicativo criado no Portal do Azure](assets/microsoft-guide-11.png)
