---
description: Descreve o painel da Velocidade da oportunidade para controlar o tempo em cada estágio das vendas e comparar as tendências por canal ao longo do tempo
...
![Os estágios antes de &#39;Criação de oportunidade&#39; usarão a data de ponto de contato mais recente como](assets/lead-dashboard-1.png)
...
![Em qual mês as oportunidades tiveram a progressão mais rápida pelas vendas](assets/lead-dashboard-2.png)

### Velocidade da oportunidade por canal {#opportunity-velocity-by-channel}

O gráfico de barras exibe a duração média, em dias, dos leads/contatos em cada estágio do funnel, segmentados por Canal.

* Passe o mouse sobre uma linha para revelar informações detalhadas.

Perguntas que o gráfico responde:

* Qual canal mostra a progressão mais rápida pelos estágios do funnel?
* Como a velocidade da oportunidade no estágio &quot;Prospecto&quot; varia entre diferentes canais?

![Como a velocidade da oportunidade no estágio &#39;Prospecto&#39; varia entre diferentes](assets/lead-dashboard-3.png)
