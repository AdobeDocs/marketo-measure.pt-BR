---
description: Explore o painel de ROI para comparar a receita e o ROI dos custos entre canais, subcanais e campanhas ao longo do tempo
title: Painel de ROI
feature: Reporting
...
![ROI realizado: receita atribuída realizada dividida pelos custos na data filtrada](assets/roi-dashboard-9.png)
...
![Há canais ou subcanais com valores excepcionalmente altos ou baixos](assets/roi-dashboard-8.png)?
...
![Como a tendência do ROI realizado está relacionada a qualquer marketing significativo](assets/roi-dashboard-7.png)
...
![Como os custos de um canal específico evoluíram com o tempo?](assets/roi-dashboard-6.png)
...
![Quais canais de marketing (canal, subcanal ou campanha) parecem ter financiamento insuficiente em comparação a outros?](assets/roi-dashboard-5.png)
