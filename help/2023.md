---
description: Orientação das notas de versão de 2023 para usuários do Marketo Measure
...
A tabela de URL no [data warehouse](/help/data-warehouse-schema.md){target="_blank"} agora incluirá um campo de título da página, além das tabelas de dados da web.
...
* [Novo guia do painel do Discover](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Noções básicas do painel do Discover](/help/discover-dashboard-basics.md){target="_blank"}
* [Painel de visão geral da receita](/help/revenue-overview-dashboard.md){target="_blank"}
* [Painel de receita atribuída](/help/attributed-revenue-dashboard.md){target="_blank"}
* [Painel de ROI](/help/roi-dashboard.md){target="_blank"}
* [Painel de passaporte](/help/passport-dashboard.md){target="_blank"}
...
Vamos eliminar gradualmente nossos processos de exportação para objetos de clientes potenciais e contatos a fim de simplificar a integração e eliminar a necessidade de exportação para objetos padrão do Salesforce. Os campos desnormalizados listados abaixo também serão descontinuados, pois os clientes podem obter os mesmos dados de seus objetos Touchpoint. _**A linha do tempo de desativação é junho de 2024.**_
...
![Criar novos Tipos de Relatório para Clientes Potenciais e Contatos com ou sem Pontos de Contato.](assets/release-notes-3.png)
...
![Remover campos FT/LC de Cliente Potencial/Contato:](assets/release-notes-5.png)

* Adicionar campos de touchpoint:

![Adicionar campos de Touchpoint:](assets/release-notes-4.png)
...
![O filtro Posição do Ponto de Contato e qualquer filtro que use os campos FT/LC](assets/release-notes-2.png)

![O filtro Posição do Ponto de Contato e qualquer filtro que use os campos FT/LC](assets/release-notes-1.png)
...
* Para permanecer conectado ao Dynamics, instale a versão mais recente do pacote, v6.12. As versões antigas `(<v6.12)` não terão mais suporte. Essa atualização otimiza a criação de registros históricos para reduzir o uso do armazenamento.

* O método desatualizado do OAuth com um RefreshToken será descontinuado. Consulte [este guia](/help/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} para atualizar as credenciais e seguir as práticas recomendadas da Microsoft para o uso do ClientSecret.
...
[Este artigo](/help/configuration-and-setup/salesforce-package-consolidation.md){target="_blank"} inclui guias sobre como recriar relatórios e painéis de pacotes de relatórios herdados.
