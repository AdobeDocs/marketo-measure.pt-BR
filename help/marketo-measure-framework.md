---
description: Estrutura do Marketo Measure
...
>[!NOTE]
>Para obter instruções sobre como adicionar o JS do Marketo Measure, [clique aqui](/help/marketo-measure-tracking/adding-marketo-measure-script.md).
...
![A Marketo Measure integra-se aos CRMs para hospedar e organizar todos os dados](assets/overview-resources-14.png)
...
![A maioria dos profissionais de marketing depende de alguns aplicativos diferentes para executar seu marketing](assets/overview-resources-15.png)
