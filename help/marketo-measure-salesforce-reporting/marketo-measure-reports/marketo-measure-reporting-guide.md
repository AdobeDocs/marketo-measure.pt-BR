...
<table> 
 <tbody>
   ...
   *Um filtro de Segmento para 'Tipo de oportunidade' deve ser usado em [!DNL Marketo Measure] Descobrir</td> 
  </tr>
  <tr>
   <td>Campo de data / Tipo de data</td> 
