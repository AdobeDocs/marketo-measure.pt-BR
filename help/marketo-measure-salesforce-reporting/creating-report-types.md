...
1. Vá para **[!UICONTROL Configuração]** > **[!UICONTROL Compilação]** > **[!UICONTROL Tipos de Relatório]** > **[!UICONTROL Novos Tipos de Relatório Personalizado]**.
   ...
   ![1. Ir para os Tipos de Relatório de Compilação de Instalação Novo](assets/new-types-1.png)
...
1. Defina o Tipo de relatório personalizado.
   ...
   * [!UICONTROL Implantação] > [!UICONTROL Status de Implantação]: implantado
   ...
   ![Status de Implantação: Implantado](assets/new-types-10.jpg)
...
1. Defina os Relacionamentos entre objetos.
   ...
   * [!UICONTROL Salvar]
   ...
   ![Salvar](assets/new-types-11.png)
...
1. Vá para **[!UICONTROL Configuração]** > **[!UICONTROL Compilação]** > **[!UICONTROL Tipos de Relatório]** > **[!UICONTROL Novos Tipos de Relatório Personalizado]**.
   ...
   ![1. Ir para os Tipos de Relatório de Compilação de Instalação Novo](assets/new-types-12.png)
...
1. Defina o Tipo de relatório personalizado.
   ...
   * [!UICONTROL Implantação] > [!UICONTROL Status de Implantação]: implantado
   ...
   ![Status de Implantação: Implantado](assets/new-types-13.jpg)
...
1. Defina o Tipo de relatório personalizado.
   ...
   * [!UICONTROL Implantação] > [!UICONTROL Status de Implantação]: implantado
   ...
   ![Status de Implantação: Implantado](assets/new-types-14.jpg)
...
1. Defina os Relacionamentos entre objetos.
   ...
   * [!UICONTROL Salvar]
   ...
   ![Salvar](assets/new-types-15.png)
