...
![Os pontos de contato de Criação pós-lead (PostLC) do Marketo Measure estão disponíveis para clientes que usam o](assets/additional-functionality-1.png)
...
![Os pontos de contato PostLC são dinâmicos. Como um Cliente Potencial ou Contato continua a enviar](assets/additional-functionality-2.png)
