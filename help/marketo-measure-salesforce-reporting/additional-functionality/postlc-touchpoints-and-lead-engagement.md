---
description: Touchpoints pós-LC e engajamento de lead
...
![Registro de cliente potencial mostrando pontos de contato PostLC no Salesforce](assets/1.png)
...
![Lista de pontos de contato PostLC limitada a quatro envios mais recentes](assets/2.png)
...
1. Insira o número de pontos de contato postLC que você gostaria de encaminhar para seus clientes em potencial e clique em **[!UICONTROL Salvar]**.
   ...
   ![Página de configurações de cliente potencial para definir o limite do ponto de contato PostLC](assets/3.png)
...
1. Insira o número de pontos de contato postLC que você gostaria de encaminhar para seus Contatos e clique em **[!UICONTROL Salvar]**.
   ...
   ![Contate a página de configurações para definir o limite do ponto de contato PostLC](assets/4.png)
